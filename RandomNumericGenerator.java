...
public class RandomNumericGenerator {
	// krijon vlere numerike me numer te percaktuar karakteresh per te testuar limitin e nje fushe
	...
	// krijon vlera mbi ose nen vleren e lejuar ne baze te tipit te te dhenave (int,double, float)
